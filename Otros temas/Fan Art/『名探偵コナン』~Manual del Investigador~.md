...
```mermaid
graph TD
    classDef inicial fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef proceso fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef verificacion fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef conclusion fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px

    A[("🔎 PROTOCOLO<br/>INVESTIGATIVO")]:::inicial
    B["📋 Recepción del Caso<br/>• Evaluación inicial<br/>• Alcance y recursos"]:::inicial
    C["🔍 Investigación de Campo<br/>• Recolección de evidencia<br/>• Entrevistas y observación"]:::proceso
    D["🧪 Análisis Forense<br/>• Pruebas científicas<br/>• Validación técnica"]:::proceso
    E["✅ Verificación<br/>• Contraste de fuentes<br/>• Validación de hipótesis"]:::verificacion
    F["📊 Resultados<br/>• Conclusiones<br/>• Recomendaciones"]:::conclusion
...
```mermaid
graph TD
    classDef proceso fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef etapas fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef metodo fill:#9370DB,stroke:#4B0082,color:white,stroke-width:2px

    A[("🔎 PROCESO<br/>INVESTIGATIVO")]:::metodo

    B["📝 Planificación<br/>• Objetivos claros<br/>• Recursos necesarios<br/>• Timeline definido"]:::proceso
    
    C["🎯 Ejecución<br/>• Recolección de datos<br/>• Análisis riguroso<br/>• Verificación continua"]:::proceso
    
    D["📊 Resultados<br/>• Conclusiones sólidas<br/>• Recomendaciones<br/>• Documentación"]:::etapas
...
```mermaid
graph TD
    classDef jefes fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef operativos fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef cientifico fill:#32CD32,stroke:#006400,color:white,stroke-width:2px

    A[("🕶️ ORGANIZACIÓN<br/>DE NEGRO")]:::jefes
    B["💀 Altos Mandos<br/>• Gin - Ejecutor<br/>• Vermouth - Infiltrada<br/>• Rum - Estratega"]:::jefes
    C["🔫 Operativos<br/>• Vodka - Secuaz<br/>• Chianti - Francotiradora<br/>• Korn - Asesino"]:::operativos
    D["🧪 División Científica<br/>• Sherry - APTX 4869<br/>• Otros investigadores<br/>• Laboratorios secretos"]:::cientifico
...
```mermaid
graph TD
    classDef observacion fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px
    classDef analisis fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef deduccion fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px
    classDef metodo fill:#4169E1,stroke:#000080,color:white,stroke-width:2px

    A[("🔍 MÉTODO<br/>CONAN")]:::metodo
    B["👀 Observación<br/>• Visión panorámica<br/>• Detalles específicos<br/>• Patrones ocultos"]:::observacion
    C["🧪 Análisis<br/>• Evidencia física<br/>• Testimonios<br/>• Línea temporal"]:::analisis
    D["💡 Deducción<br/>• Conexión de pistas<br/>• Eliminación de imposibles<br/>• Reconstrucción del crimen"]:::deduccion
...
```mermaid
graph TD
    classDef casos fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef tipo1 fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef tipo2 fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef tipo3 fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px

    A[("🔍 TIPOS DE<br/>CASOS")]:::casos
    B["💀 Asesinatos<br/>• Habitación cerrada<br/>• Coartadas perfectas<br/>• Trucos elaborados"]:::tipo1
    C["🕵️ Conspiraciones<br/>• Organización de Negro<br/>• APTX 4869<br/>• Redes criminales"]:::tipo2
    D["🎭 Otros Crímenes<br/>• Robos de Kaito Kid<br/>• Secuestros<br/>• Extorsiones"]:::tipo3
...
```mermaid
graph TD
    classDef inicio fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef investigacion fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef analisis fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef conclusion fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px

    A[("🔍 MÉTODO<br/>DETECTIVE")]:::inicio
    B["1. Definición<br/>• 5W1H<br/>• Alcance"]:::inicio
    C["2-3. Observación<br/>• Recolección<br/>• Detalles"]:::investigacion
    D["4-5. Análisis<br/>• Patrones<br/>• Verificación"]:::analisis
    E["6-7. Documentación<br/>• Registro<br/>• Teorías"]:::investigacion
    F["8-9. Experimentación<br/>• Pruebas<br/>• Motivos"]:::analisis
    G["10-12. Conclusión<br/>• Presentación<br/>• Seguimiento"]:::conclusion
...
```mermaid
graph TD
    classDef teoria fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef evidencia fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef validacion fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px

    A[("💡 DESARROLLO<br/>DE TEORÍAS")]:::teoria
    B["📝 Hipótesis Inicial<br/>• Evidencia básica<br/>• Primeras sospechas"]:::teoria
    C["🔍 Análisis Profundo<br/>• Conexiones<br/>• Contradicciones"]:::evidencia
    D["⚖️ Validación<br/>• Pruebas<br/>• Verificación"]:::validacion
...
```mermaid
graph TD
    classDef justicia fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef verdad fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef oscura fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef enfoque fill:#9370DB,stroke:#4B0082,color:white,stroke-width:2px

    A[("⚖️ ENFOQUES DE<br/>JUSTICIA")]:::enfoque

    B["🌟 Justicia Conan<br/>• Verdad sobre todo<br/>• Protección inocentes<br/>• Redención posible"]:::justicia
    
    C["🔍 Verdad Policial<br/>• Evidencia científica<br/>• Proceso legal<br/>• Orden público"]:::verdad
    
    D["🌑 Organización Oscura<br/>• Poder absoluto<br/>• Sin redención<br/>• Eliminación total"]:::oscura
...
```mermaid
graph TD
    classDef principios fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef legal fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef etico fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef practico fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px

    A[("⚖️ MARCO LEGAL Y<br/>ÉTICO")]:::principios
    B["📜 Principios Legales<br/>• Normativas<br/>• Regulaciones<br/>• Jurisprudencia"]:::legal
    C["🎭 Principios Éticos<br/>• Integridad<br/>• Confidencialidad<br/>• Responsabilidad"]:::etico
    D["🔧 Aplicación Práctica<br/>• Protocolos<br/>• Procedimientos<br/>• Supervisión"]:::practico
...
```mermaid
graph TD
    classDef proteccion fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef analisis fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef custodia fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef doc fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px

    A[("🔍 MANEJO DE<br/>EVIDENCIA")]:::proteccion
    B["📸 Documentación<br/>• Fotografías<br/>• Videos<br/>• Notas"]:::doc
    C["🧪 Análisis<br/>• Laboratorio<br/>• Pruebas<br/>• Resultados"]:::analisis
    D["🔒 Cadena de Custodia<br/>• Control<br/>• Registro<br/>• Seguridad"]:::custodia
...
```mermaid
graph TD
    classDef gadgets fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef comms fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef seguridad fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px

    A[("🔧 TECNOLOGÍA<br/>DETECTIVE")]:::gadgets
    B["🎭 Gadgets Conan<br/>• Pajarita moduladora<br/>• Reloj anestesiante<br/>• Zapatillas amplificadoras"]:::gadgets
    C["📡 Comunicaciones<br/>• Red encriptada<br/>• Transmisores ocultos<br/>• Base de datos global"]:::comms
    D["🛡️ Seguridad<br/>• Monitores vitales<br/>• GPS de emergencia<br/>• Alarmas silenciosas"]:::seguridad
...
```mermaid
graph TD
    classDef metodos fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef tecno fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef equipo fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px
    classDef centro fill:#9370DB,stroke:#4B0082,color:white,stroke-width:2px

    A[("🎯 METODOLOGÍA<br/>INTEGRADA")]:::centro

    B["🔍 Métodos Clásicos<br/>• Observación detallada<br/>• Deducción lógica<br/>• Análisis forense"]:::metodos
    
    C["💻 Tecnología Avanzada<br/>• Análisis digital<br/>• Base de datos global<br/>• IA investigativa"]:::tecno
    
    D["👥 Trabajo en Equipo<br/>• Liga de Detectives<br/>• Red internacional<br/>• Expertos especializados"]:::equipo
...
```mermaid
graph TD
    classDef basico fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef avanzado fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef experto fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef formacion fill:#9370DB,stroke:#4B0082,color:white,stroke-width:2px

    A[("🎓 DESARROLLO<br/>PROFESIONAL")]:::formacion

    B["📚 Nivel Básico<br/>• Observación básica<br/>• Técnicas forenses<br/>• Protocolos estándar"]:::basico
    
    C["🔬 Nivel Avanzado<br/>• Casos complejos<br/>• Liderazgo de equipo<br/>• Tecnología especializada"]:::avanzado
    
    D["⭐ Nivel Experto<br/>• Casos internacionales<br/>• Investigación avanzada<br/>• Mentorías"]:::experto
...
```mermaid
graph TD
    classDef liderazgo fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef operativo fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef soporte fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px
    classDef division fill:#9370DB,stroke:#4B0082,color:white,stroke-width:2px

    A[("🏢 TRUTHSEEKERS<br/>INTERNATIONAL")]:::division

    B["👥 Consejo Principal<br/>• Shinichi - Estrategia<br/>• Heiji - Operaciones<br/>• Kogoro - Experiencia<br/>• Megure - Enlace Policial"]:::liderazgo
    
    C["🔍 Equipos Operativos<br/>• Liga Juvenil de Detectives<br/>• Unidad de Investigación<br/>• Red de Informantes<br/>• Equipo de Respuesta Rápida"]:::operativo
    
    D["🛠️ Soporte Técnico<br/>• Lab. Agasa - I+D<br/>• Haibara - Análisis<br/>• Equipo Forense<br/>• Centro de Datos"]:::soporte
...
```mermaid
graph TD
    classDef red fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef soporte fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef aliados fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px
    classDef global fill:#9370DB,stroke:#4B0082,color:white,stroke-width:2px

    A[("🌐 RED GLOBAL DE<br/>COLABORACIÓN")]:::global

    B["🔍 Red de Detectives<br/>• Detectives privados<br/>• Policías locales<br/>• Investigadores amateur"]:::red
    
    C["🛠️ Soporte Técnico<br/>• Laboratorios forenses<br/>• Centros de datos<br/>• Expertos tecnológicos"]:::soporte
    
    D["🤝 Aliados Estratégicos<br/>• FBI y CIA<br/>• INTERPOL<br/>• Agencias gubernamentales"]:::aliados
...
graph TD
    classDef seguridad fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef prevencion fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
    classDef respuesta fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef proteccion fill:#9370DB,stroke:#4B0082,color:white,stroke-width:2px

    A[("🛡️ SISTEMA DE<br/>PROTECCIÓN")]:::proteccion

    B["🔒 Seguridad Personal<br/>• Protocolos de anonimato<br/>• Comunicación segura<br/>• Identidades protegidas"]:::seguridad
    
    C["⚡ Prevención<br/>• Análisis de riesgos<br/>• Monitoreo continuo<br/>• Alertas tempranas"]:::prevencion
    
    D["🚨 Respuesta a Crisis<br/>• Evacuación rápida<br/>• Apoyo legal inmediato<br/>• Protección de evidencia"]:::respuesta
...
graph TD
    ...
    classDef proceso fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef verificacion fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef resolucion fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px

    A[("🌐 RESOLUCIÓN DE<br/>CONFLICTOS")]:::inicio
    B["📝 Recepción Caso<br/>• Documentación<br/>• Evaluación inicial"]:::inicio
    C["🔍 Investigación<br/>• Recolección evidencia<br/>• Análisis"]:::proceso
    D["✅ Verificación<br/>• Contraste fuentes<br/>• Validación"]:::verificacion
    E["📊 Presentación<br/>• Hallazgos<br/>• Recomendaciones"]:::resolucion
    F["🤝 Mediación<br/>• Diálogo<br/>• Acuerdos"]:::resolucion
