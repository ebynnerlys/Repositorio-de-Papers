...
```mermaid
graph TD
    classDef personal fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef relacion fill:#FFB6C1,stroke:#8B0000,color:black,stroke-width:2px
    classDef practico fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px
    classDef crianza fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px
    classDef mental fill:#DDA0DD,stroke:#800080,color:black,stroke-width:2px
    classDef igualdad fill:#F0E68C,stroke:#BDB76B,color:black,stroke-width:2px
    classDef futuro fill:#FFA07A,stroke:#FF6347,color:black,stroke-width:2px

    A[("❓ ANÁLISIS<br/>INTEGRAL")]
    B["🎯 Preparación Personal<br/>• Experiencias pasadas<br/>• Expectativas futuras<br/>• Madurez emocional"]:::personal
    C["💑 Compatibilidad<br/>• Dinámica de pareja<br/>• Resolución conflictos<br/>• Valores compartidos"]:::relacion
    D["📋 Aspectos Prácticos<br/>• Finanzas y logística<br/>• Apoyo y recursos<br/>• Planificación"]:::practico
    E["👶 Estilo de Crianza<br/>• Métodos educativos<br/>• Valores familiares<br/>• Visión compartida"]:::crianza
    F["🧠 Salud Mental<br/>• Manejo del estrés<br/>• Bienestar emocional<br/>• Apoyo psicológico"]:::mental
    G["⚖️ Igualdad de Género<br/>• Roles compartidos<br/>• Educación inclusiva<br/>• Modelado equitativo"]:::igualdad
    H["🔮 Planificación Futura<br/>• Adaptabilidad<br/>• Economía familiar<br/>• Tecnología reproductiva"]:::futuro
...
```mermaid
graph TD
    classDef femenino fill:#FFB6C1,stroke:#8B0000,color:black,stroke-width:2px
    classDef masculino fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px
    classDef comun fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px

    A[("👩 Especialización<br/>Biológica Femenina")]:::femenino
    B[("👨 Especialización<br/>Biológica Masculina")]:::masculino
    C[("🧬 Núcleo Humano Universal<br/>• Razonamiento y consciencia<br/>• Derechos humanos fundamentales<br/>• Igualdad ante la ley<br/>• Dignidad inherente<br/>• Libertad y autonomía")]:::comun
...
```mermaid
graph TD
    classDef biologica fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef mental fill:#FFB6C1,stroke:#8B0000,color:black,stroke-width:2px
    classDef normas fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px

    A[("🎯 TIPOS DE<br/>MADUREZ")]
    B["🧬 Madurez Biológica<br/>• 16-18 años<br/>• Desarrollo físico<br/>• Fertilidad óptima"]:::biologica
    C["🧠 Madurez Mental<br/>• Variable (ej: 30+)<br/>• Desarrollo psicológico<br/>• Responsabilidad"]:::mental
    D["⚖️ Normas de Seguridad<br/>• Sistema PEGI<br/>• Protección<br/>• Prevención"]:::normas
...
```mermaid
graph TD
    classDef optimo fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef gradual fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px
    classDef final fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px

    A[("⏳ CICLO DE<br/>FERTILIDAD")]
    B["⬆️ Potencial Máximo<br/>• 20-30 años: óptimo<br/>• 20-25% éxito mensual<br/>• Máxima fertilidad"]:::optimo
    C["➡️ Disminución Gradual<br/>• 35 años: 10% éxito<br/>• 40 años: 5% éxito<br/>• Cambios hormonales"]:::gradual
    D["⬇️ Etapa Final<br/>• Menopausia<br/>• Fin reproductivo<br/>• Nueva etapa vital"]:::final

    E["🌿 Factores Positivos<br/>• Dieta balanceada<br/>• Peso saludable<br/>• Estilo vida activo"]:::optimo
    F["⚠️ Factores Negativos<br/>• Toxinas ambientales<br/>• Tabaco y alcohol<br/>• Estrés crónico"]:::final
...
graph TD
    ...
    classDef mental fill:#FFB6C1,stroke:#8B0000,color:black,stroke-width:2px
    classDef marcador fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px

    A[("🔬 MARCADORES DE<br/>DESARROLLO")]
    B["🧬 Marcadores Biológicos<br/>• Menarquia (mujeres)<br/>• Espermatogénesis (hombres)<br/>• Cambios hormonales"]:::bio
    C["🧠 Desarrollo Cerebral<br/>• Córtex prefrontal (20-25 años)<br/>• Control emocional<br/>• Toma de decisiones"]:::mental
    D["📊 Estudios Científicos<br/>• Add Health<br/>• NIMH<br/>• Neuroimagen"]:::marcador
...
```mermaid
graph TD
    classDef tempranas fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef intermedias fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px
    classDef tardias fill:#FF6347,stroke:#8B0000,color:white,stroke-width:2px

    A[("🧠 DESARROLLO<br/>FUNCIONES EJECUTIVAS")]
    B["🎯 Tempranas 4-8 años<br/>• Detección de riesgos<br/>• Control inhibitorio<br/>• Decisiones básicas"]:::tempranas
    C["⚡ Intermedias 7-13 años<br/>• Memoria de trabajo<br/>• Flexibilidad mental<br/>• Resolución problemas"]:::intermedias
    D["🌟 Tardías 15-25 años<br/>• Planificación compleja<br/>• Abstracción<br/>• Juicio maduro"]:::tardias
...
```mermaid
graph TD
    classDef europa fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px
    classDef asia fill:#FFB6C1,stroke:#8B0000,color:black,stroke-width:2px

    A[("🌍 PERCEPCIÓN<br/>MAYORÍA EDAD")]
    B["🇪🇺 Europa Occidental<br/>• Alemania: 38.75 años<br/>• España: 53.04 años<br/>• Francia: 24.94 años"]:::europa
    C["🌏 Asia Oriental<br/>• China: 18.94 años<br/>• Corea: menor disociación<br/>• Mayor respeto edad"]:::asia
...
graph TD
    classDef bio fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef salud fill:#FFB6C1,stroke:#8B0000,color:black,stroke-width:2px
    classDef demo fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px

    A[("🔄 FERTILIDAD Y<br/>LONGEVIDAD")]
    B["🧬 Intercambio Biológico<br/>• Menos hijos: más longevidad<br/>• 2-3 hijos: nivel óptimo<br/>• Genes vs energía"]:::bio
    C["🩺 Indicadores de Salud<br/>• >18 meses para concebir<br/>• +21% hospitalizaciones<br/>• +46% mortalidad mujeres"]:::salud
    D["📊 Tendencias Globales<br/>• Mayor esperanza vida<br/>• Menor fertilidad<br/>• Desarrollo económico"]:::demo
...
```mermaid
graph TD
    classDef dispositivos fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef monitoreo fill:#FFB6C1,stroke:#8B0000,color:black,stroke-width:2px
    classDef farma fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px
    classDef emergente fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px

    A[("🧪 TECNOLOGÍAS<br/>REPRODUCTIVAS")]
    B["🔧 Cooper Surgical<br/>• Dispositivos médicos<br/>• Sistemas micromanipulación<br/>• Catéteres avanzados"]:::dispositivos
    C["📊 Vitrolife<br/>• Tiempo-lapse<br/>• Tecnología láser<br/>• Selección embrionaria"]:::monitoreo
    D["💊 Ferring Pharma<br/>• Gonadotropinas<br/>• Soporte hormonal<br/>• Implantación embrionaria"]:::farma
    E["🧬 Gameto Inc<br/>• Gametogénesis in vitro<br/>• Maduración óvulos<br/>• Tecnología emergente"]:::emergente
...
```mermaid
graph TD
    classDef ia fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef gen fill:#FFB6C1,stroke:#8B0000,color:black,stroke-width:2px
    classDef nano fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px

    A[("🔬 INNOVACIÓN<br/>REPRODUCTIVA")]
    B["🤖 IA en Fertilidad<br/>• Mojo: análisis esperma<br/>• Life Whisperer: selección<br/>• Univfy: predicción éxito"]:::ia
    C["🧬 Genética Avanzada<br/>• Invitae: PGD<br/>• Celmatix: terapias<br/>• Biomarcadores"]:::gen
    D["🔬 Nanotecnología<br/>• Entrega fármacos<br/>• Diagnóstico temprano<br/>• Mejora FIV"]:::nano
...
```mermaid
graph TD
    classDef etica fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef legal fill:#FFB6C1,stroke:#8B0000,color:black,stroke-width:2px
    classDef tension fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px

    A[("⚖️ LEY 14/2006<br/>REPRODUCCIÓN ASISTIDA")]
    B["✨ Principios Éticos<br/>• Autonomía reproductiva<br/>• Bienestar del niño<br/>• Avance científico"]:::etica
    C["🚫 Límites Legales<br/>• Máx. 3 embriones/ciclo<br/>• Máx. 6 niños/donante<br/>• No gestación subrogada"]:::legal
    D["⚡ Tensiones<br/>• Progreso vs regulación<br/>• Acceso vs restricción<br/>• Innovación vs control"]:::tension
...
```mermaid
graph TD
    classDef usa fill:#FFB6C1,stroke:#8B0000,color:black,stroke-width:2px
    classDef esp fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef comp fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px

    A[("🌍 REGULACIÓN<br/>REPRODUCTIVA")]
    B["🇺🇸 EE.UU.<br/>• Sin ley federal uniforme<br/>• Varía por estado<br/>• Más libertad comercial"]:::usa
    C["🇪🇸 España<br/>• Ley 14/2006 unificada<br/>• Regulación estricta<br/>• Límites claros"]:::esp
    D["📊 Diferencias Clave<br/>• Gestación subrogada<br/>• Cobertura seguros<br/>• Límites embriones"]:::comp
...
|-----------------|----------------------|---------------------|-------------------|
| Feminización | • Hematomas (5.8%)<br/>• Infecciones<br/>• Sangrado | • Perforación intestinal<br/>• Estrangulamiento uretral | 1-2 meses |
| Masculinización | • Problemas uretrales<br/>• Fístulas<br/>• Infecciones prótesis | • Necrosis<br/>• Pérdida sensibilidad | 2-3 meses |
...
```mermaid
graph TD
    classDef metabolismo fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef hormonal fill:#FFB6C1,stroke:#8B0000,color:black,stroke-width:2px
    classDef adaptacion fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px

    A[("⚡ METABOLISMO<br/>Y ENERGÍA")]
    B["🏃‍♂️ Utilización de Sustratos<br/>• Mujeres: Mayor oxidación de grasas<br/>• Hombres: Mayor uso de carbohidratos<br/>• Impacto en rendimiento"]:::metabolismo
    C["🔄 Regulación Hormonal<br/>• Estrógenos: Preservación energética<br/>• Testosterona: Anabolismo muscular<br/>• Ciclos adaptativos"]:::hormonal
    D["💪 Adaptaciones Evolutivas<br/>• Eficiencia mitocondrial<br/>• Distribución de reservas<br/>• Supervivencia reproductiva"]:::adaptacion
...
graph TD
    ...
    classDef adapt fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px

    A[("🏋️ OPTIMIZACIÓN<br/>DE ENTRENAMIENTO")]
    B["👩 Estrategias Femeninas<br/>• Mayor volumen aeróbico<br/>• Periodización hormonal<br/>• Preservación energética"]:::fem
    C["👨 Estrategias Masculinas<br/>• Mayor intensidad anaeróbica<br/>• Entrenamiento de fuerza<br/>• Alta demanda glucolítica"]:::masc
    D["🎯 Principios Adaptados<br/>• Nutrición específica<br/>• Recuperación personalizada<br/>• Progresión individual"]:::adapt
...
|---------|------------|------------|
| Nutrición | • 1.5-2g proteína/kg peso<br/>• Ajuste calórico según ciclo<br/>• Prioridad hierro y calcio<br/>• Recargas estratégicas | • Mayor ingesta total<br/>• Énfasis carbohidratos<br/>• 2g+ proteína/kg peso<br/>• Progresión lineal |
| Entrenamiento | • 2-3 sesiones fuerza/semana<br/>• Limitar aeróbico excesivo<br/>• Adaptar a fase menstrual<br/>• Prevención osteopenia | • Mayor volumen total<br/>• Intensidad progresiva<br/>• Foco hipertrofia<br/>• Recuperación estable |
| Recuperación | • Variable según ciclo<br/>• Mayor necesidad sueño<br/>• Monitoreo hormonal<br/>• Prevención sobreentrenamiento | • Patrones consistentes<br/>• Énfasis proteína<br/>• Control cortisol<br/>• Adaptación lineal |
