...
```mermaid
graph TD
    classDef leve fill:#90EE90,stroke:#006400,color:black,stroke-width:2px
    classDef moderado fill:#FFD700,stroke:#B8860B,color:black,stroke-width:2px
    classDef grave fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef categoria fill:#4169E1,stroke:#000080,color:white,stroke-width:2px
...
```mermaid
graph TD
    classDef humana fill:#87CEEB,stroke:#4682B4,color:black,stroke-width:2px
    classDef moral fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef absoluta fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef justicia fill:#4169E1,stroke:#000080,color:white,stroke-width:2px

    A[("⚖️ TIPOS DE<br/>JUSTICIA")]:::justicia

    B["🌸 Justicia Humana<br/>Fujitora<br/>• Compasión<br/>• Admite errores<br/>• Protege inocentes"]:::humana
    C["🔬 Justicia Moral<br/>Zentomaru<br/>• Principios firmes<br/>• Desafía el poder<br/>• Defiende verdad"]:::moral
    D["🌋 Justicia Absoluta<br/>Akainu<br/>• Sin excepciones<br/>• Obediencia total<br/>• Poder absoluto"]:::absoluta
...
```mermaid
graph TD
    classDef control fill:#DC143C,stroke:#8B0000,color:white,stroke-width:2px
    classDef balance fill:#FFD700,stroke:#DAA520,color:black,stroke-width:2px
    classDef libertad fill:#98FB98,stroke:#228B22,color:black,stroke-width:2px
    classDef estilo fill:#4169E1,stroke:#000080,color:white,stroke-width:2px

    A[("🎭 ESTILOS DE<br/>LIDERAZGO")]:::estilo

    B["⛓️ Control Total<br/>Gobierno Mundial<br/>• Poder centralizado<br/>• Obediencia ciega<br/>• Sin autonomía"]:::control
    C["⚖️ Balance Sabio<br/>Garp<br/>• Autonomía guiada<br/>• Lealtad por respeto<br/>• Desarrollo personal"]:::balance
    D["🌟 Libertad Responsable<br/>Luffy<br/>• Confianza plena<br/>• Crecimiento mutuo<br/>• Familia unida"]:::libertad
...
```mermaid
graph TD
    classDef libertad fill:#1E90FF,stroke:#4169E1,color:white,stroke-width:2px
    classDef justicia fill:#32CD32,stroke:#006400,color:white,stroke-width:2px
    classDef resistencia fill:#FF6347,stroke:#8B0000,color:white,stroke-width:2px
    classDef etica fill:#9370DB,stroke:#4B0082,color:white,stroke-width:2px

    A[("🚩 ÉTICA<br/>REVOLUCIONARIA")]:::etica

    B["💫 Libertad Sustantiva<br/>Dragon<br/>• Liberación genuina<br/>• Justicia estructural<br/>• Transformación sistémica"]:::libertad
    C["⚖️ Justicia Restaurativa<br/>Sabo<br/>• Reparación del daño<br/>• Reconciliación<br/>• Segunda oportunidad"]:::justicia
    D["🔥 Resistencia Ética<br/>Koala<br/>• No violencia<br/>• Medios proporcionales<br/>• Proteger inocentes"]:::resistencia
